...
export default function Footer() {
  const { run, prompt, promptChangeHandler } = useContext(Context);

  return (
    <footer>
      <form onSubmit={(e) => run(e, prompt)} className='flex items-center justify-between bg-white bg-opacity-10 rounded-lg p-4'>
